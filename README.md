...
Prebuilt platforms: `linux-x64`, `linux-arm64`, `macos-x64`, `macos-arm64`;
on anything else build from source (below). Releases are cut dm.ai-style by
pressing the **Run workflow** button in
