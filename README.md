...
- [fa-story-dev.json](machine-kit/teammate-install/runners/fa-story-dev.json) — story development teammate
- [fa-bug-dev.json](machine-kit/teammate-install/runners/fa-bug-dev.json) — bug development teammate
