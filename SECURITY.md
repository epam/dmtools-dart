...
1. Open a [GitHub Security Advisory](https://github.com/epam/dmtools-dart/security/advisories/new) (preferred — keeps the report private until patched).
...
We follow the [GitHub coordinated disclosure guidelines](https://docs.github.com/en/code-security/security-advisories/guidance-on-reporting-and-writing-information-about-vulnerabilities).
...
- Keep your DMTools installation up to date: `curl -fsSL https://github.com/epam/dmtools-dart/releases/latest/download/install.sh | sh`
