...
/// `@MCPTool` annotations): title/find/search/user coverage, URL fetch,
/// history-aware update, uploads, and the page downloader.
List<ToolDefinition> _javaNameTools() => [
      ToolDefinition(
...
class ConfluenceToolExecutor {
  ...
  late final Map<String, Future<dynamic> Function(Map<String, dynamic>)>
    ...
    'confluence_content_by_title': (a) =>
        _client.contentByTitle(a['title'] as String, a['format'] as String?),
    'confluence_content_by_title_and_space': (a) =>
        _client.contentByTitleAndSpace(
          a['title'] as String,
          a['space'] as String,
          a['format'] as String?,
        ),
    'confluence_contents_by_urls': (a) => _client.contentsByUrls(
    ...
    'confluence_find_content_by_title_and_space': (a) => _client.findContent(
          a['title'] as String,
          space: a['space'] as String,
          format: a['format'] as String?,
        ),
    'confluence_find_or_create': (a) => _client.findOrCreate(
          a['title'] as String,
          a['parentId'] as String,
          a['body'] as String,
        ),
    'confluence_get_children_by_name': (a) => _client.getChildrenByName(
          a['spaceKey'] as String,
          a['contentName'] as String,
          a['format'] as String?,
        ),
    'confluence_get_content_attachments': (a) =>
        _client.getContentAttachments(a['contentId'] as String),
    'confluence_get_current_user_profile': (_) =>
        _client.getCurrentUserProfile(),
