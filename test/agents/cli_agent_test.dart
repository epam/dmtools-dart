...
/// Tracker-specific prompt resolution during the CLI phase (gh-125): the
/// builder must receive the active tracker (`DEFAULT_TRACKER`) so
/// `cliPromptsByTracker` selects the right markup rules. The prompt is
/// observed end-to-end by `cat`-ing the appended prompt file — its stdout
/// becomes the command response.
