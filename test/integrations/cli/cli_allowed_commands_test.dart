...
/// Tests for the `cli_list_allowed_commands` tool in [CliToolExecutor] and
/// [cliTools].
void main() {
...
/// Catalog checks for `cli_list_allowed_commands`.
void catalogTests() {
  group('cliTools catalog: cli_list_allowed_commands', () {
