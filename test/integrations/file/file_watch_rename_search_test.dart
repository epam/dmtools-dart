...
/// Tests for the watch, rename, and search file tools (`file_watch`,
/// `file_rename`, `file_search`) in [FileToolExecutor] and [fileTools].
void main() {
  catalogTests();
  watchTests();
  renameTests();
...
Directory _tempDir() =>
    Directory.systemTemp.createTempSync('dmtools_file_watch_rename_search_');

/// Catalog checks for the watch, rename, and search tools.
void catalogTests() {
  group('fileTools catalog: watch/rename/search', () {
    ...
    test('includes the watch/rename/search tool names', () {
    ...
    test('every watch/rename/search tool belongs to the file integration', () {
