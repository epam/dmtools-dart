...
/// Pull-request lifecycle — merge/close/reopen, diff, files, and reviews —
...
void executorPrMutationTests() {
  group('GithubToolExecutor.execute (PR mutations)', () {
    ...
    test('github_close_pr sends state closed; reopen sends open', () async {
      final close = mockGithub(_router);
      ...
      final reopen = mockGithub(_router);
...
String _router(RequestOptions o) {
  final listEndpoint = o.path.endsWith('/files');
