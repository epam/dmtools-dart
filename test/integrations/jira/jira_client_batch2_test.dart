...
/// Batch-2 tests: getComments, assignTo, updateField, createTicketBasic,
/// getTransitions, deleteTicket, clearField — plus executor dispatch.
void main() {
  ...
  deleteTicketTests();
  clearFieldTests();
  batch2ExecutorReadDispatchTests();
  batch2ExecutorWriteDispatchTests();
}
...
/// [JiraToolExecutor.execute] routes read batch-2 tool names correctly.
void batch2ExecutorReadDispatchTests() {
  group('JiraToolExecutor.execute (batch-2 reads)', () {
...
/// [JiraToolExecutor.execute] routes write batch-2 tool names correctly.
void batch2ExecutorWriteDispatchTests() {
  group('JiraToolExecutor.execute (batch-2 writes)', () {
    late _SpyJiraClient spy;
    late JiraToolExecutor executor;
